...
export const EditButton = ({ rowData }) => (
    <LinkButton
      icon={<CreateIcon />}
      link={`${client.provider}/${rowData.id}`}
      iconButton
    />
);

export const DeleteProvider = ({rowData, metadata }) => (
    <Button
      variant="contained"
      color="secondary"
...
const ProvidersListForm = observer(({ 
    providersList, 
    tableColumn
  }) => (
  ...
  ProvidersListForm.propTypes = {
    providersList: PropTypes.array.isRequired
  };
  
  export default ProvidersListForm;